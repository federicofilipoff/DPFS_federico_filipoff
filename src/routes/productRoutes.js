...
router.post('/', isAdmin, upload.single('image'), productValidator.store, productController.store);
router.get('/search', productController.search);
router.get('/create', isAdmin, productController.create);
router.get('/cart', productController.cart);
router.get('/:id/edit', isAdmin, productController.edit);
router.put('/:id', isAdmin, upload.single('image'), productValidator.update, productController.update);
